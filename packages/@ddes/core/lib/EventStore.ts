...
export abstract class EventStore {
	 ...
	 */
	public abstract scanAggregateCommitsGroupedByKey<
		TAggregateCommit extends AggregateCommit,
	>(type: string): AsyncIterable<TAggregateCommit[]>
	...
	public abstract getAggregateHeadCommit<
		TAggregateCommit extends AggregateCommit,
	>(type: string, key: string): Promise<TAggregateCommit | undefined>
	 ...
	 */
	public abstract chronologicalQuery<
		TAggregateCommit extends AggregateCommit,
	>(params: {
		min: string | Date
		max?: string | Date
	...
	public abstract streamAggregateInstanceCommits<
		TAggregateCommit extends AggregateCommit,
	>(
